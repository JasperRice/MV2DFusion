...
def create_nuscenes_infos(
    ...
    if test:
        ...
        info_path = osp.join(
            root_path, "{}_temporal_infos_test_new.pkl".format(info_prefix)
        )
        ...
        data = dict(infos=train_nusc_infos, metadata=metadata)
        info_path = osp.join(
            root_path, "{}_temporal_infos_train_new.pkl".format(info_prefix)
        )
        mmcv.dump(data, info_path)
        data["infos"] = val_nusc_infos
        info_val_path = osp.join(
            root_path, "{}_temporal_infos_val_new.pkl".format(info_prefix)
        )
